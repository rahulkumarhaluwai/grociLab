...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex">
      <div className ="hidden lg:flex lg:w-1/2 bg-green relative items-center justify-center">
        <img src={heroSectionData.hero_image} className='absolute inset-0 object-cover h-full bg-center opacity-100'/>
        <div className="relative text-center px-12">
          <h2 className='text-4xl font-semibold text-white mb-4'>Welcome back to grociLab</h2>
